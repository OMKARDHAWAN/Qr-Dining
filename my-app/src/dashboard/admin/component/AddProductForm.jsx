...
const AddProductForm = ({ onClose }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        description: "",
        price: "",
        categoryName: "", // Bound to string name
        image: null,
        status: true
    });
    ...
    const handleSubmit = async (e) => {
        ...
        data.append("categoryName", formData.categoryName); // Sends string category name
        ...
        <div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50">
            <div className="bg-white rounded-xl shadow-xl w-[500px] p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {/* Bind dropdown to categoryName and use categoryName as the values */}
                    <select
                        name="categoryName"
