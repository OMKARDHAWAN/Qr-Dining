  ...
  return (
    <div className="bg-white h-24 px-10 flex justify-between items-center border-b shadow-sm">
      ...
      <div className="flex items-center gap-6">
        ...
        <FiBell className="text-2xl cursor-pointer hover:text-orange-500" />

        <FiSettings className="text-2xl cursor-pointer hover:text-orange-500" />

        <div className="flex items-center gap-3">
          <div className="text-right">
            <h3 className="font-semibold">Krish Kapoor</h3>
